...
# ---------------------------------------------------------------------------
# Repo layout + textual-free sibling modules
# ---------------------------------------------------------------------------

# tui_data and tui_format live alongside this script (made importable by the
# sys.path insert above). They hold the data-loading and pure-formatting
# helpers, split out so they stay unit-testable and importable without pulling
# in Textual. REPO_ROOT is defined in tui_data so the loaders and this launcher
# agree on one repo root.
